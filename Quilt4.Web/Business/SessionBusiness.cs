...
namespace Quilt4.Web.Business
{
    public class SessionBusiness : ISessionBusiness
    {
        ...
        public void RegisterSessionEx(RegisterSessionRequest request)
        {
            ...
            var applicationVersion = _applicationVersionBusiness.RegisterApplicationVersion(fingerprint, application.Id, request.Session.Application.Version, request.Session.Application.SupportToolkitNameVersion, request.Session.Application.BuildTime);
