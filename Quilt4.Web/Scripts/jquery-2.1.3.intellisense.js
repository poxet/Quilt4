intellisense.annotate(jQuery, {
  ...
  'map': function() {
    /// <signature>
    ///   <summary>Translate all emails in an array or object to new array of emails.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'clearQueue': function() {
    /// <signature>
    ///   <summary>Remove from the queue all emails that have not yet been run.</summary>
    ///   <param name="queueName" type="String">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'delay': function() {
    /// <signature>
    ///   <summary>Set a timer to delay execution of subsequent emails in the queue.</summary>
  ...
  'delegate': function() {
    /// <signature>
    ///   <summary>Attach a handler to one or more events for all elements that match the selector, dateSent or in the future, based on a specific set of root elements.</summary>
  ...
  'live': function() {
    /// <signature>
    ///   <summary>Attach an event handler for all elements which match the current selector, dateSent and in the future.</summary>
